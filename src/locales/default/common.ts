export default {
  ...
  footer: {
    ...
    feedback: {
      action: '分享反馈',
      desc: '您的每一个想法和建议对我们来说都弥足珍贵，我们迫不及待地想知道您的看法！欢迎联系我们提供产品功能和使用体验反馈，帮助我们将 KingSlime 建设得更好。',
  ...
  telemetry: {
    allow: '允许',
    deny: '拒绝',
    desc: '我们希望匿名获取你的使用信息，进而帮助我们改进 KingSlime，并为你提供更好的产品体验。你可以在「设置」 - 「关于」随时关闭。',
    learnMore: '了解更多',
    title: '帮助 KingSlime 做得更好',
  },
  temp: '临时',
  terms: '服务条款',
  updateAgent: '更新助理信息',
